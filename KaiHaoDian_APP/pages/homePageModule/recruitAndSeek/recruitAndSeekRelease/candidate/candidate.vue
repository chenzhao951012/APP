<template>
	<view class="content">
		...
		<view class="_infoFill">
		 	<view class="_left">求职岗位</view>
		 	<input class="_right" type="text" placeholder="请输入" maxlength="28" v-model="title"/>
		</view>
		<!-- 行业类型 -->
		<view class="_infoFill">
			<view class="_left">行业类别</view>
		 	<view class="_right" @click="showSinglePicker2" data-type="1">{{pickerText1}}</view>
		</view>
		<!-- 期望薪资 -->
		<view class="_infoFill">
			<view class="_left" style="width: 200upx;">期望薪资</view>
		...
		<view class="_infoFill">
		 	...
		 	<input class="_right" type="number" placeholder="请输入联系电话"/>
		</view>
		<!-- 所在区域 -->
		<view class="_infoFill">
		...
		<view class="_title_instructions">
		 	<view class="_title_top">求职描述</view>
		 	<textarea type="text" placeholder="请输入" maxlength="200" v-model="jobRequirements"/>
		</view>
		<!-- 单选题 -->
		<view class="_confirm">
	...
	export default {
		...
		data() {
					return {
						...
						pickerText1: '请选择',
						 salarylist: [
									  { value: "0", salarymin: "0", salarymax: "1000", label: '1000以下' },
									  { value: "1", salarymin: "1000", salarymax: "2000", label: '1000 -2000元' },
									  { value: "2", salarymin: "2000", salarymax: "3000", label: "2000-3000元" },
									  { value: "3", salarymin: "4000", salarymax: "5000", label: '3000-5000元' },
									  { value: "4", salarymin: "4000", salarymax: "5000", label: '5000-8000元' },
									  { value: "5", salarymin: "4000", salarymax: "5000", label: '8000-12000元' },
									  { value: "6", salarymin: "4000", salarymax: "5000", label: '12000-20000元' },
									  { value: "7", salarymin: "4000", salarymax: "5000", label: '20000以上' },
								  ],
						industrylist: [
							  { value: "0", label: "餐饮美食" },
							  { value: "1", label: "美容保健" },
