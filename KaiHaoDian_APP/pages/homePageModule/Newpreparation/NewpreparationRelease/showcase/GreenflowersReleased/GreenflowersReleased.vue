		...
		<view class="ramage">
			<view class="ramageType">
				<view class="introduce">
					...
					<view class="shopTitle shopTitle2">
							<navigator url="particularCommodity/particularCommodity"><text class="iconfont">&#xe616;</text></navigator>
					</view>
				</view>
			</view>
			<view class="ramageType">
				<view class="introduce">
					...
					<view class="shopTitle shopTitle2">
							<navigator url="MoregoodsRelease/MoregoodsRelease"><text class="iconfont">&#xe616;</text></navigator>
					</view>
				</view>
			</view>
