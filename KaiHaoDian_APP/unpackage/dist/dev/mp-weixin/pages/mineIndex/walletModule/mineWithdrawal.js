...
var render = function() {
  ...
  return _c("view", { staticClass: "content" }, [
    _c("view", { staticClass: "all_content" }, [
      _vm._m(0),
      _c("view", { staticClass: "_withdrawal_amount" }, [_vm._v("提现金额")]),
      _c("view", { staticClass: "_money_amount" }, [
        _vm._v("¥"),
        _c("input", {
          directives: [
            {
          ...
          attrs: { type: "text", eventid: "350bbde8-0" },
          domProps: { value: _vm.inpValue },
          on: {
      ...
      _c("view", { staticClass: "_change_balance" }, [
        _vm._v("零钱余额¥"),
        _c("text", { staticClass: "_number_amount" }, [
      ...
      _c("view", { staticClass: "_withDrawal_button" }, [_vm._v("提现")])
    ])
  ])
}
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("view", { staticClass: "_top_content" }, [
      _c("view", { staticClass: "_micro_letter" }, [_vm._v("到账微信")]),
      _c("view", { staticClass: "_micro_letter_content" }, [
        _c("image", { staticClass: "_micro_letter_image", attrs: { src: "" } }),
        _c("view", { staticClass: "_micro_letter_info" }, [
          _c("view", { staticClass: "_micro_letter_name" }, [
            _vm._v("名称（昵称）")
          ]),
          _c("view", { staticClass: "_arrive_time" }, [_vm._v("2小时之内到账")])
        ])
      ])
    ])
  }
...
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/pages/mineIndex/walletModule/mineWithdrawal.js.map